...
const struct v4l2_format_info *v4l2_format_info(u32 format)
{
	static const struct v4l2_format_info formats[] = {
		...
		/* Doesn't really fit here but try it anyway - no idea what to do about SAND30 */
		{ .format = V4L2_PIX_FMT_SAND8,   .pixel_enc = V4L2_PIXEL_ENC_YUV, .mem_planes = 1, .comp_planes = 2, .bpp = { 1, 2, 0, 0 }, .hdiv = 2, .vdiv = 2 },
